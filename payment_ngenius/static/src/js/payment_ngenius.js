odoo.define('payment_ngenius.payment_ngenius', function (require) {
    "use strict"
    var payment_widget = require('payment.payment_form');
    var core = require('web.core');
    var _t = core._t;
    console.log('Called for paymebnt')
                ...
                if ($tx_url.length === 1) {
                    ...
                    return this._rpc({
                        ...
                        if (result) {
                            ...
                            var method = $(newForm).find('input[name="data_set"]').data('method') || 'post';
                            newForm.setAttribute("method", method); // set it to post
